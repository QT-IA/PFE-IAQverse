...
function initEmptyCharts() {
  ...
  Plotly.newPlot('co2-chart', [{ x: [], y: [], type: 'scatter', mode: 'lines+markers' }], makeCommonLayout('Évolution du CO₂', 'ppm'), config);
  Plotly.newPlot('pm25-chart', [{ x: [], y: [], type: 'bar' }], makeCommonLayout('Concentration de PM2.5', 'µg/m³'), config);
  ...
  Plotly.newPlot('tvoc-chart', [{ x: [], y: [], type: 'scatter' }], makeCommonLayout('Concentration de TVOC', 'mg/m³'), config);
}
